...
class DDQNAgent:
    ...
    def __init__(self, mode="train", nodes=32, memory_size=10000, final_act="linear", minibatch=32, lr=1e-3,
        ...
        self.LOAD_MODEL = "ddqn/best/model - (0.01 64 10000 49 linear 10000)____83.49max___23.00 avg___-0.60min.h5"
...
if __name__ == "__main__":
    ...
    main(num_episodes=5000, memory_size=10_000, nodes=49, minibatch=128, lr=1e-2)
