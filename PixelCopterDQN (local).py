...
class DQNAgent:
    ...
    MODEL_FILE = "dqn/02-05-2021/DQN model LR=0.01 BATCH=32 MEM_SIZE=3000____22.00max____1.57 avg___-5.00min.h5"
...
def learn(nodes=14, num_episodes=5000, memory_size=3000, final_act="linear", minibatch=32, lr=1e-2):
